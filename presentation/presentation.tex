...
\begin{frame}{\LaTeX{} can be used at home or online.}
	...
	\begin{itemize}
        ...
        \item There are also online compilers/editors (especially helpful for collaboration)
        \begin{itemize}
        	\item \url{http://writelatex.com}
        	\item \url{http://sharelatex.com}
        	\item The basic way to edit is to \textit{latexdiff}.
        \end{itemize}
...
\begin{frame}[fragile]{BibTeX handles making the references and making the bibliography.}
	\begin{columns}
    	\column{0.5\textwidth}
        	\begin{itemize}
            \item Just put your references (automatically generated by Google Scholar) in a .bib file that you reference at the end of the document, \cite{HallEffect}
...
\begin{frame}
References slide? (Makes more sense at the end of a paper.)
